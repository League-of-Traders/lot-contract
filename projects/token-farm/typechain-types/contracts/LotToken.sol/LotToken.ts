...
export interface LotTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface LotToken extends BaseContract {
  connect(runner?: ContractRunner | null): LotToken;
  waitForDeployment(): Promise<this>;

  interface: LotTokenInterface;
